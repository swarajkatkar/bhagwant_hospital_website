...
const galleryImages = [
  ...
  { src: 'https://res.cloudinary.com/dt4mqa1ba/image/upload/v1775300572/guest-room_tjgimq.png', name: 'Patient Rooms' },
  ...
  { src: 'https://res.cloudinary.com/dt4mqa1ba/image/upload/v1775300583/parking_vsz7te.png', name: 'Parking Facility' },
